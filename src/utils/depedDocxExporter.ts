...
export async function generateILAWDocxBlob(
    ...
    sections: [
      {
        ...
        children: [
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: `${header.region.toUpperCase()} • ${header.division.toUpperCase()}`,
                bold: true,
                size: 20,
                color: '334155'
              })
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: header.school.toUpperCase(),
                bold: true,
                size: 24,
                color: '002776'
              })
          ...
          new Paragraph({
            text: `INSTRUCTIONAL LEADERSHIP AND ACADEMIC WORKFLOW (ILAW) — ${header.lesson.toUpperCase()}`,
            heading: HeadingLevel.HEADING_1,
            alignment: AlignmentType.CENTER,
            spacing: { before: 200, after: 120 }
          }),
          new Paragraph({
            text: `Learning Area: ${header.learningArea} | Term ${header.term} (${header.bowWeek}) | Grade & Section: ${header.gradeLevelAndSection}`,
            alignment: AlignmentType.CENTER,
            spacing: { after: 200 }
          }),
          new Paragraph({
            text: `Inclusive Teaching Dates: ${header.inclusiveTeachingDates} | Prepared by: ${header.teacher}`,
            alignment: AlignmentType.CENTER,
            spacing: { after: 300 }
          })
        ]
