...
const QUICK_PROMPTS = [
  { label: '📋 SHS Faculty Loadings (49 Teachers)', icon: GraduationCap, text: 'Show the complete LNNCHS Senior High School Teacher Loading Summary for SY 2026-2027 with all 49 faculty, departments, regular and ALS periods, advisory credits, and official signatories' },
  { label: '📅 SHS Class Programs & Rotational SII', icon: Calendar, text: 'Show the Senior High School Class Programs for Pure Academic and TechPro tracks and the Grade 12 Rotational School Intervention Initiatives (SII) schedule' },
  { label: '📝 60-Item RUTE & Life/Career Exams', icon: Award, text: 'Show the 60-Item RUTE Examination in Kasaysayan, the Life & Career Skills Exam with TOS & Answer Key by Mary Els Markines, and the 60-Item OMR Bubble Sheet' },
  { label: '📑 4-Day ILAW + LAS', icon: FileText, text: 'Generate 4-Day ILAW Lesson Plan session (Day 1, 2, 3, 4) with Lesson Proper aligned to competencies and combined LAS individual and group activities' },
  { label: '⚡ EduAccess 24/7', icon: Sparkles, text: 'Explain the EduAccess Universal Unlimited Hours and Sabay-Sabay simultaneous access policy' },
  { label: '🕌 World Religions', icon: HeartHandshake, text: 'Compare the core beliefs and Philippine context of Roman Catholics, Muslims, Jehovah\'s Witnesses, and Buddhism' },
  { label: '📥 LRMDS Downloads', icon: BookOpen, text: 'Search and list free downloadable LRMDS modules from lrmds.deped.gov.ph' },
  { label: '🔬 Explain Photosynthesis', icon: Sparkles, text: 'Explain photosynthesis for Grade 7 science with age-appropriate examples' },
  { label: '🇵🇭 1896 Revolution', icon: Calendar, text: 'What happened during the 1896 Philippine Revolution?' },
  { label: '✍️ Pang-abay (Grammar)', icon: BookOpen, text: 'Explain pang-abay with classifications, examples, and sentences' },
