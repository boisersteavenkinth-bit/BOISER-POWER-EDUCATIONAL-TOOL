                  ...
                  <div className="sm:col-span-2">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <div className="flex items-center gap-1.5 text-[10px]">
                        <span className="text-stone-400">Quick Recipient:</span>
                        <button
                          type="button"
                          onClick={() => setComposeTo('operativecreative@gmail.com')}
                          className="px-2 py-0.5 rounded bg-blue-50 hover:bg-blue-100 text-[#0038A8] font-bold transition cursor-pointer"
                        >
                          operativecreative@gmail.com
                        </button>
                        <button
                          type="button"
                          onClick={() => setComposeTo('boisersteavenkinth@gmail.com')}
                    ...
                    <input
                      ...
                      placeholder="e.g. operativecreative@gmail.com, principal@deped.gov.ph"
